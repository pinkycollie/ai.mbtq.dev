        ...
        <div className="flex-1 overflow-auto">
          <div className="border-b">
            <div className="flex h-16 items-center px-6">
              <h1 className="text-lg font-semibold">AI Project Generator</h1>
            </div>
          </div>
          <div className="p-6">
            <Card className="border-red-200">
              <CardContent className="pt-6 flex flex-col items-center justify-center min-h-[400px]">
                ...
                <p className="text-muted-foreground mb-4">We encountered an error loading the AI Project Generator</p>
